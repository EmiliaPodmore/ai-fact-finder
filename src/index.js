...
function generateFact(event) {
  ...
  let context =
    "You are a knowledgeable AI assistant that can provide intriguing facts. Your task is to present an interesting fact using basic HTML, keeping it short and no longer than 6 lines. Avoid including a title or heading, and ensure adherence to user instructions.";
  ...
  factElement.innerHTML = `<div class="spinner"></div>`;
